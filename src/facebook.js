...
const FB_COOKIE_BASE = 'sb=abc123; datr=xyz789; reg_ext_ref=deleted; fr=0; presence=C%7B%22t3%22%3A%5B%5D%7D';
...
function buildFbHeaders(type = 'mobile', additional = {}) {
  const base = type === 'mobile' ? { ...FB_MOBILE_HEADERS } : { ...FB_DESKTOP_HEADERS };
  if (type === 'graph') return { ...FB_GRAPH_HEADERS, ...additional };
  base.Cookie = FB_COOKIE_BASE;
  return { ...base, ...additional };
}

/**
 * Parsea HTML de mbasic.facebook.com y extrae contenido textual.
 * @param {string} html - HTML de la página mbasic.
 * @returns {Object} Contenido extraído.
 */
